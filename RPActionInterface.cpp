...
namespace KCL_rosplan {
	...
	void RPActionInterface::runActionInterface() {
		...
		//Topic to subscribe to get response from Appiot
		std::string bat = "/ros_out";
		appiot_action_pub = nh.advertise<rosplan_dispatch_msgs::ActionDispatch>(bat, 10, true);
